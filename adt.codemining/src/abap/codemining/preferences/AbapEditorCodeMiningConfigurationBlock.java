...
public class AbapEditorCodeMiningConfigurationBlock extends OptionsConfigurationBlock {
	...
	public AbapEditorCodeMiningConfigurationBlock(IStatusChangeListener context,
	...
	private void createMethodParameterSection(int nColumns, Composite parent) {
		...
		getCheckBox(PREF_SHOW_METHOD_PARAMETER_BY_USING_FILTERS);
	}
